...
namespace Ictshop.Controllers
{
    public class UserController : Controller
    {
        ...
        public string GetIDGroub(string userMail)
        {
            var data = (from a in db.Nguoidungs
                        join b in db.PhanQuyens on a.IDQuyen equals b.IDQuyen
